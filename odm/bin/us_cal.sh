...
case "$1" in
    ...
    "near" )
        ...
        ;;
    "full" )
        playfilename=/odm/etc/audio/mi_us_whitenoise.wav
    ...
    "near2far" )
        ...
        ;;
    "cal_wn" )
        /odm/bin/mi_ultrasound_test -near /data/data/us_near2far.wav -far /data/data/us_far2near.wav
...
echo "start playing"
agmplay $playfilename -r 96000 -D 100 -d 100 -i TDM-LPAIF_VA-RX-PRIMARY-VIRT-0  -dkv 0xA2000001
